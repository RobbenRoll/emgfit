...
offers automisation features whenever reasonable while also supporting a
...
* Automatic import of relevant literature values from the AME database ADD LINK!
...
`emgfit` is designed to be used within iPython notebooks which have become a
